...
sim_device_policing_recovery <- function(name, config) {
  ...
  files.trajectories = list.files("./sim/trajectories/device_policing_recovery/", full.names = T)
  ...
  resources[, `:=`(name = name,
                   ...
                   policing_n_devices = config$policing$n_dev,
                   sim = "device_policing_recovery")]
