...
sim_simple_dropping_recovery<- function(name, config) {
  ...
  files.trajectories = list.files("./sim/trajectories/simple_dropping_recovery/", full.names = T)
  ...
  resources[, `:=`(name = name,
                   ...
                   queue_cmap = config$queue$cmap,
                   queue_auc = config$queue$auc,
                   queue_hlr = config$queue$hlr,
                   queue_spc = config$queue$spc,
                   queue_isd = config$queue$isd,
                   sim = "simple_dropping_recovery")]
